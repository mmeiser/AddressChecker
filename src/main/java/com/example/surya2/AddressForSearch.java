...
public class AddressForSearch {
    ...
    private CampusInfoForSearch campusInfo;
    private String city;
    ...
    public CampusInfoForSearch getCampusInfo() {
        return campusInfo;
    }

    public void setCampusInfo(CampusInfoForSearch campusInfo) {
    ...
    public int getStreetSideId() {
        return streetSideId;
    }

    public void setStreetSideId(int streetSideId) {
        this.streetSideId = streetSideId;
    }
